...
using TimeClock4.ViewModels.AccountViewModels;
...
namespace TimeClock4.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> CreateUser(CreateUserViewModel newUser)
        {
            ...
            {
                //Create the user
                var user = new ApplicationUser{FirstName = newUser.FirstName, LastName = newUser.LastName, Email = newUser.Email,
                                                UserName = newUser.Email, HourlyWage = newUser.HourlyWage};
